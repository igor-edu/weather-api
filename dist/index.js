...
function handleSearchForm(e) {
  ...
  const searchUrl = `https://api.mapbox.com/geocoding/v5/mapbox.places/${search}.json?access_token=pk.eyJ1IjoiaWdvcmNvbCIsImEiOiJjazlzY3E0Y3kxMnlwM2hwbmpvc25raHBoIn0.C07xU-VzZpdFzHJCro2Qng`;
